...
//        config.put("workerNum", "2");
        
        config.put("workerList", "[127.0.0.1:8000]");
//        config.put("dbDir", "/Users/yimengxu/Documents/workspace/HW3/diDir");
        config.put("store", "/Users/yimengxu/Documents/workspace/HW3/store");
        config.put("input", "source1");
        config.put("output", "output1");
        config.put("masterAddress", "127.0.0.1:8080");
